...
void ASwdCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ASwdCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ASwdCharacter::TouchStopped);
}

void ASwdCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void ASwdCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}
